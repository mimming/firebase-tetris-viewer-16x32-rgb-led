...
PPMWriter.prototype.writeBody = function() {
  function pixelToBytes(stuff) {
    var buf2 = new Buffer(3);
    buf2.writeUInt8(stuff[0], 0);
    buf2.writeUInt8(stuff[1], 1);
    buf2.writeUInt8(stuff[2], 2);
    return buf2;
  }

  while(this.stream.write(pixelToBytes(this.image[this.cur_row][this.cur_col]))) {
